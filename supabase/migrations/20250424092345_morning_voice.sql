/*
  # Add FireCrawl Integration Support
  
  1. Changes
    - Adds fields to system_settings table for FireCrawl API configuration
    - Creates a dedicated cache table for FireCrawl results
    
  2. Purpose
    - Enable additional news aggregation from FireCrawl API
    - Track API usage and rate limiting for FireCrawl
*/

-- Add new fields to system_settings table for FireCrawl API
